...
| [1.0.0-preview.7 release notes](docs/release-notes-1.0.0-preview.7.md) | ItemsView selection, invocation, layout, transitions, WPF adaptations, and migration information. |
