...
using ItemsRepeaterTestApp.Samples.Model;
using System;
...
{
    public partial class PinterestLayoutSamplePage : Page
    {
        ...
        private void BringIntoView_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                var anchor = repeater.GetOrCreateElement(index) as FrameworkElement;
