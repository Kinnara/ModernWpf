...
![ModernWPF Gallery showing controls, samples, and navigation](https://raw.githubusercontent.com/Kinnara/ModernWpf/v1.0.0-preview.5/docs/images/Gallery.Light.png)
...
- [Preview 5 release notes](https://github.com/Kinnara/ModernWpf/blob/v1.0.0-preview.5/docs/release-notes-1.0.0-preview.5.md)
- [Migrate from ModernWPF 0.9.x](https://github.com/Kinnara/ModernWpf/blob/v1.0.0-preview.5/docs/migrating-from-0.9.md)
