...
![ModernWPF Gallery showing controls, samples, and navigation](https://raw.githubusercontent.com/Kinnara/ModernWpf/v1.0.0-preview.6/docs/images/Gallery.Light.png)
...
- [Preview 6 release notes](https://github.com/Kinnara/ModernWpf/blob/v1.0.0-preview.6/docs/release-notes-1.0.0-preview.6.md)
- [Migrate from ModernWPF 0.9.x](https://github.com/Kinnara/ModernWpf/blob/v1.0.0-preview.6/docs/migrating-from-0.9.md)
