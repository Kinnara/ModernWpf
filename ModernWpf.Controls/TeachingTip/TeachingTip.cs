...
namespace ModernWpf.Controls
{
    public partial class TeachingTip : ContentControl
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            m_titleTextBox = GetTemplateChild(s_titleTextBoxName) as UIElement;
            m_subtitleTextBox = GetTemplateChild(s_subtitleTextBoxName) as UIElement;
            ...
            {
                AutomationProperties.SetName(alternateCloseButton, Strings.TeachingTipAlternateCloseButtonName);
                ToolTip tooltip = new ToolTip();
                tooltip.Content = Strings.TeachingTipAlternateCloseButtonTooltip;
        ...
        private bool UpdateTail()
        {
            ...
            (float firstColumnWidth, float secondColumnWidth, float nextToLastColumnWidth, float lastColumnWidth) GetColumnWidths()
            {
            ...
            (float firstRowHeight, float secondRowHeight, float nextToLastRowHeight, float lastRowHeight) GetRowHeights()
            {
        ...
        //    {
        //            if (var && titleTextBox = m_titleTextBox)
        //            {
        ...
        //    {
        //            if (var && subtitleTextBox = m_subtitleTextBox)
        //            {
        ...
        private Thickness BottomPlacementTopRightHighlightMargin(double width, double height) { return new Thickness((width / 2) + (TailShortSideLength() - 1.0f), 0, 3, 0); }
        private Thickness BottomRightPlacementTopRightHighlightMargin(double width, double height) { return new Thickness(MinimumTipEdgeToTailEdgeMargin() + TailLongSideLength() - 1.0f, 0, 3, 0); }
        private Thickness BottomLeftPlacementTopRightHighlightMargin(double width, double height) { return new Thickness(width - (MinimumTipEdgeToTailEdgeMargin() + 1.0f), 0, 3, 0); }
        private static Thickness OtherPlacementTopRightHighlightMargin(double width, double height) { return new Thickness(0, 0, 0, 0); }

        private Thickness BottomPlacementTopLeftHighlightMargin(double width, double height) { return new Thickness(3, 0, (width / 2) + (TailShortSideLength() - 1.0f), 0); }
        private Thickness BottomRightPlacementTopLeftHighlightMargin(double width, double height) { return new Thickness(3, 0, width - (MinimumTipEdgeToTailEdgeMargin() + 1.0f), 0); }
        private Thickness BottomLeftPlacementTopLeftHighlightMargin(double width, double height) { return new Thickness(3, 0, MinimumTipEdgeToTailEdgeMargin() + TailLongSideLength() - 1.0f, 0); }
        private static Thickness TopEdgePlacementTopLeftHighlightMargin(double width, double height) { return new Thickness(3, 1, 3, 0); }
