    ...
    public class ItemsView : Control
    {
            ...
            out int index)
        {
            ...
            var target = new Point(
                horizontalRatio * Math.Max(0.0, _scrollView.ViewportWidth),
                verticalRatio * Math.Max(0.0, _scrollView.ViewportHeight));
        ...
        protected override void OnPreviewKeyDown(KeyEventArgs e)
        {
            ...
            if (e.Handled || !IsNavigationKey(e.Key) || _itemsSourceView == null || _itemsSourceView.Count == 0)
            {
                return;
            }
        ...
        private void ConfigureItemContainer(ItemContainer itemContainer)
        {
            ...
            itemContainer.MultiSelectMode = ItemContainerMultiSelectMode.Auto | multiSelectMode;
        }
