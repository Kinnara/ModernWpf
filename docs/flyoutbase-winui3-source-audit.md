...
Latest verified result on 2026-05-18: `MenuFlyoutApiTests.PresenterShadowFollowsWinUISource` passed, and the focused presenter/shadow/template parity slice passed 35/35 with:
