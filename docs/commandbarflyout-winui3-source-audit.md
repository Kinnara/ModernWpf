...
- WinUI touch/gamepad input-mode selection is not wired to WPF platform input mode; the style resources and visual states are preserved where WPF can apply them.
...
Latest verified result on 2026-05-17: CommandBarFlyout API tests passed 20/20.
