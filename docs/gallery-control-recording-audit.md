...
| Text | RichTextEdit | `item/RichTextEdit` | Recorded failure | Open | `artifacts/gallery-recordings/20260606-080845-863/RichTextEdit/light-richtextedit.mp4` | Current Light and Dark focused reruns fail with `AfterOutput=""`, so the older `artifacts/gallery-recordings/20260606-014544-783/RichTextEdit/dark-richtextedit.mp4` proof is stale under the current desktop session. Failed evidence includes `20260606-075521-729` Light, `20260606-075734-362` Dark, and `20260606-080845-863` Light screen mode. Manual diagnostics found the RichTextBox UIA element, but normal keyboard focus stayed on the agent monitor after `SetFocus` and topmost click attempts; external keyboard-style recording cannot currently prove RichTextEdit input here. |
