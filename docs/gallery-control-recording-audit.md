...
| Media | PersonPicture | `item/PersonPicture` | Recorded | No issue found in current pass | `artifacts/gallery-recordings/20260606-022033-503/PersonPicture/dark-personpicture.mp4` | Static rendered route with nonblank frames against required anchor `GallerySample_PersonPicture_PersonPicture`; latest frame review found no obvious blank, stale, or misaligned region. |
| Styles | IconElement | `item/IconElement` | Recorded | Recorder anchor fixed | `artifacts/gallery-recordings/20260606-022033-503/IconElement/dark-iconelement.mp4` | Static rendered route with nonblank frames against required anchor `GallerySample_IconElement_ExampleButton1`; latest frame review found rendered icons, wrapped text, and no obvious clipped content. |
| Styles | ThemeShadow | `item/ThemeShadow` | Recorded | Sample anchor fixed | `artifacts/gallery-recordings/20260606-022033-503/ThemeShadow/dark-themeshadow.mp4` | Static rendered route with nonblank frames against required anchor `GallerySample_ThemeShadow_TranslationSlider`; latest frame review found the shadow sample and slider visible. |
...
| Status & info | InfoBadge | `item/InfoBadge` | Recorded | Sample anchor fixed | `artifacts/gallery-recordings/20260606-022033-503/InfoBadge/dark-infobadge.mp4` | Static rendered route with nonblank frames against required anchor `GallerySample_InfoBadge_NavigationView`; latest frame review found the embedded NavigationView and badge styles visible. |
...
| Menus & toolbars | AppBarSeparator | `item/AppBarSeparator` | Recorded | No issue found in current pass | `artifacts/gallery-recordings/20260606-022033-503/AppBarSeparator/dark-appbarseparator.mp4` | Static rendered route with nonblank frames against required anchor `GallerySample_AppBarSeparator_AttachCameraButton`; latest frame review found visible separators and aligned AppBar commands. |
