...
| Design Guidance pages | Mostly done | Color, Iconography, Typography, Spacing, and Geometry now use adapted official WPF Gallery page shells/XAML with direct-page runtime tests; Color subsections now use official-style color controls and XAML; Spacing and Geometry design images now switch with the ModernWpf actual theme; the Light item visual audit is recorded. |
...
| Design Guidance section | Partial | Partial | Partial | Color, Iconography, Typography, Spacing, and Geometry now use adapted official WPF Gallery page shells/XAML; Typography and Geometry sample code panes are runtime-covered; Light item visual audit recorded at `artifacts/wpf-gallery-visual-audit/20260522-114444/report.md`; section-page capture itself remains open because the official reference app stayed on Home in diagnostic artifact `artifacts/wpf-gallery-visual-audit/20260522-112648/report.md`. |
| Color | Done | Done | Partial | Direct page shell and all six subsections now use adapted official WPF Gallery XAML with `PageHeader`, selector, `ColorPageExample`, and `ColorTile`; Light visual audit recorded at `artifacts/wpf-gallery-visual-audit/20260522-114444/report.md` with delta `8.54` and crops `863x767` vs `868x758`. |
| Typography | Done | Done | Partial | Adapted from official WPF Gallery XAML with `PageHeader` and `ControlExample`; sample header/snippet is runtime-covered; Light visual audit recorded at `artifacts/wpf-gallery-visual-audit/20260522-114444/report.md` with delta `6.59` and crops `863x767` vs `868x758`. |
| Spacing | Done | Done | Partial | Adapted from official WPF Gallery XAML with `PageHeader`, spacing imagery, and spacing table; design images now switch to official light/dark assets using the ModernWpf actual theme; Light visual audit recorded at `artifacts/wpf-gallery-visual-audit/20260522-114444/report.md` with delta `8.05` and crops `863x767` vs `868x758`. |
| Geometry | Done | Done | Partial | Adapted from official WPF Gallery XAML with `PageHeader`, geometry imagery, and corner-radius table; design image now switches to official light/dark assets using the ModernWpf actual theme; sample snippet is runtime-covered; Light visual audit recorded at `artifacts/wpf-gallery-visual-audit/20260522-114444/report.md` with delta `6.98` and crops `863x767` vs `868x758`. |
| Iconography | Done | Done | Partial | Adapted from official WPF Gallery XAML with `PageHeader`, instructions, icon library, details pane, and pagination; Light visual audit recorded at `artifacts/wpf-gallery-visual-audit/20260522-114444/report.md` with delta `6.27` and crops `863x767` vs `868x758`. |
