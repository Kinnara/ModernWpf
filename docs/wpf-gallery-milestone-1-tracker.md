...
| Status & Info pages | Mostly done | ProgressBar and ToolTip now use adapted official WPF Gallery XAML pages with direct-page runtime tests; the Light visual audit is recorded with low deltas and matching inspected crops. |
...
| Status & Info section | Partial | Partial | Partial | Status item pages and item-page sample code panes now use adapted official WPF Gallery XAML; Light visual audit recorded at `artifacts/wpf-gallery-visual-audit/20260522-110941/report.md` with StatusAndInfo delta `1.07` and crops `863x767` vs `868x758`. |
| ProgressBar | Done | Done | Partial | Adapted from official WPF Gallery XAML with `PageHeader` and `ControlExample`; sample headers/snippets are runtime-covered; Light visual audit recorded at `artifacts/wpf-gallery-visual-audit/20260522-110941/report.md` with delta `0.93` and crops `863x767` vs `868x758`. |
| ToolTip | Done | Done | Partial | Adapted from official WPF Gallery XAML with `PageHeader` and `ControlExample`; sample headers/snippets are runtime-covered; Light visual audit recorded at `artifacts/wpf-gallery-visual-audit/20260522-110941/report.md` with delta `0.6` and crops `863x767` vs `868x758`. |
